...
│ │ ├── 📂courses
│ │ │ ├── 📜page.tsx # /instructor/courses — mis cursos
│ │ │ ├── 📂new
│ │ │ │ └── 📜page.tsx # /instructor/courses/new
│ │ │ └── 📂[slug]
│ │ │ ├── 📜page.tsx # /instructor/courses/[slug] editar
│ │ │ ├── 📜loading.tsx
│ │ │ └── 📂modules
│ │ │ ├── 📜page.tsx # /instructor/courses/[slug]/modules
│ │ │ └── 📂[moduleId]
│ │ │ └── 📂lessons
│ │ │ ├── 📜page.tsx
│ │ │ └── 📂[lessonId]
...
│ │ ├── 📂courses
│ │ │ ├── 📜page.tsx # /tenant/dashboard/courses
│ │ │ ├── 📂new
│ │ │ │ └── 📜page.tsx
│ │ │ └── 📂[courseId]
│ │ │ └── 📜page.tsx
